...
# um z_g zu bestimmen, muss der Winkel zwischen jeder punkt(z.B. Start punkt zu P1, p1 zu p2, p2 zu nächstem p1 punkt und ...) mithilfe von atan2 berechnet und dann 
# durch lineare Interpolation zusammen verbunden werden.'''